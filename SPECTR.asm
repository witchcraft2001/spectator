...
TabPressed:                               ; CODE XREF: RAM:477D↑j
                call    sub_4A52
                ld      a, (ClearWindow+1)
                cp      1
                jr      z, loc_481C
...
ClearScreen:                               ; CODE XREF: sub_4A12+3↑p
                ld      de, 0
                ld      hl, 2050h

.cls:                               ; CODE XREF: RAM:4B09↓j
                ld      bc, 600h + Dss.Clear
                ld      a, 20h ; ' '
                rst     10h
                ret
; ---------------------------------------------------------------------------

ClearWindow:                               ; CODE XREF: RAM:411E↑p
                                        ; RAM:413C↑p ...
                ld      de, 301h
                ld      hl, 1B1Ah
                jr      ClearScreen.cls
...
; ---------------------------------------------------------------------------
MsgTrdIsFull:   
                db 16h, 1Fh, 15h, 8Dh, 0A5h, 0E2h, 20h, 0ACh, 0A5h, 0E1h        ;Нет места на TRD диске
...
Msg2:           db  16h
                db  1Fh
                db    0
Msg3:           db  8Dh                                                         ;На TRD диске уже находится 128 файлов
                db 0A0h
aTrd_0:         db ' TRD '
...
;4B9Bh
CloseFile1:                              ; CODE XREF: RAM:Exit↑p
...
;4BABh
CloseFile2:                              ; CODE XREF: RAM:499E↑p
...
DrawBorder:                               ; CODE XREF: sub_4A12+12↑p
                ld      (loc_4C00+2), a
                ld      (loc_4C0A+2), a
                ld      (loc_4C14+2), a
                ld      (loc_4C21+2), a
...
loc_4C00:                               ; DATA XREF: DrawBorder↑w
                ld      bc, Dss.WrChar
...
loc_4C0A:                               ; DATA XREF: DrawBorder+3↑w
                ld      bc, Dss.WrChar
...
loc_4C14:                               ; DATA XREF: DrawBorder+6↑w
                ld      bc, Dss.WrChar
...
loc_4C21:                               ; DATA XREF: DrawBorder+9↑w
                ld      bc, Dss.WrChar
...
loc_4C2B:                               ; DATA XREF: DrawBorder+C↑w
                ld      bc, Dss.WrChar
...
loc_4C35:                               ; DATA XREF: DrawBorder+F↑w
                ld      bc, Dss.WrChar
...
loc_4C3F:                               ; DATA XREF: DrawBorder+12↑w
                ld      bc, Dss.WrChar
...
loc_4C4B:                               ; DATA XREF: DrawBorder+15↑w
                ld      bc, Dss.WrChar
...
aAlphastudio200:db 'AlphaStudio, 2003',0
                ds 9, 0
byte_5000:      ds 100h, 0          ; DATA XREF: sub_4AA3+1F↑w
byte_5100:      ds 2h, 0          ; DATA XREF: sub_4AA3+1F↑w
byte_5102:      ds 100h, 0          ; DATA XREF: sub_4AA3+1F↑w
...
byte_520D:       db    0
byte_520E:       db    0
FileHandler1:      db 0                    ; DATA XREF: RAM:4B9C↑r
FileHandler2:      db 0                    ; DATA XREF: RAM:4BAC↑r
